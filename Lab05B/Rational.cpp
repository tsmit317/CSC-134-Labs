...
// set object counter to 0.
unsigned int Rational::oCounter = 0;

// return the number of objects counted.
unsigned int Rational::getCount()
{
    return oCounter;
}
...
// copies rhs to another object.
void  Rational::assignment(const Rational &rhs)
{
